...
<li class="dropdown"><a  class="dropdown-toggle" data-toggle="dropdown"href="#">Application Registration<span class="caret"></span></a>
<ul class="dropdown-menu drop">
          <li><a href="regApp">Register Application</a></li>
