...
import com.his.ad.dao.ADUserMasterDao;
...
public class ADServiceImpl implements ADService {
	...
	@Autowired
	private ADUserMasterDao arUserMasterDao;
	...
	public UserMaster saveUser(UserMaster um) {
		ADUserMaster entity = new ADUserMaster();
		...
		ADUserMaster savedEntity = arUserMasterDao.save(entity);
 ...
 */
	...
	public UserMaster findUserByEmailAndPwd(String email, String pwd) {
		...
		ADUserMaster arUserMaster = arUserMasterDao.findUserByEmailAndPwd(email, encryptedPwd);
 ...
 */
	...
	public UserMaster findByEmail(String email) {
		UserMaster um=null;
		ADUserMaster entity= arUserMasterDao.findByEmail(email);
		if(entity!=null)
		{
			um=new UserMaster();
	...
	public Page<ADUserMaster> findAllUsers(int pageNo, int pageSize) {
		...
		Page<ADUserMaster> pages = arUserMasterDao.findAll(pageble);
		return pages;
	...
	public UserMaster findById(Integer userId) {
		ADUserMaster entity = arUserMasterDao.findById(userId).get();
 ...
 */
	...
	public List<UserMaster> findAllUsers() {
		...
		List<UserMaster> users = new ArrayList<UserMaster>();
		List<ADUserMaster> entities = arUserMasterDao.findAll();
		for (ADUserMaster entity : entities) {
...
public UserMaster findByIdEdit(int cid) {
	ADUserMaster entity = arUserMasterDao.findById(cid).get();
	UserMaster model = new UserMaster();
